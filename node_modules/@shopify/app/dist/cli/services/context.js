 ...
 */
async function fetchDevAppAndPrompt(app, partnersSession) {
...
async function ensureIncludeConfigOnDeploy({ org, app, partnersApp, reset, force, }) {
    ...
    if (!app.useVersionedAppConfig || force || previousIncludeConfigOnDeploy !== undefined)
        return;
...
function includeConfigOnDeployPrompt() {
