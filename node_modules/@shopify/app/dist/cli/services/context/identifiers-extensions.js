...
export async function deployConfirmed(options, extensionRegistrations, configurationRegistrations, { validMatches, extensionsToCreate, }) {
    const { extensionsNonUuidManaged, extensionsIdsNonUuidManaged } = await ensureNonUuidManagedExtensionsIds(configurationRegistrations, options.app, options.appId);
...
async function ensureNonUuidManagedExtensionsIds(remoteConfigurationRegistrations, app, appId) {
