...
export declare class App implements AppInterface {
    ...
    constructor(name: string, idEnvironmentVariableName: string, directory: string, packageManager: PackageManager, configuration: AppConfiguration, nodeDependencies: {
        [key: string]: string;
    }, webs: Web[], extensions: ExtensionInstance[], usesWorkspaces: boolean, dotenv?: DotEnvFile, errors?: AppErrors, specifications?: ExtensionSpecification[], configSchema?: zod.ZodTypeAny, remoteBetaFlags?: BetaFlag[]);
