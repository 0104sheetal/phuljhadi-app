import { WebConfigurationSchema, App, WebType, getAppScopesArray, LegacyAppSchema, getAppVersionedSchema, isCurrentAppSchema, } from './app.js';
...
class AppLoader {
    constructor({ directory, configName, mode, specifications, remoteBetas }) {
    ...
    async loaded() {
        ...
        const { directory: appDirectory, configuration, configurationLoadResultMetadata, configSchema, } = await configurationLoader.loaded();
        ...
        const appClass = new App(name, 'SHOPIFY_API_KEY', appDirectory, packageManager, configuration, nodeDependencies, webs, allExtensions, usesWorkspaces, dotenv, undefined, this.specifications, configSchema, this.remoteBetas);
...
class AppConfigurationLoader {
    constructor({ directory, configName, specifications, remoteBetas }) {
        this.directory = directory;
        this.configName = configName;
        this.specifications = specifications;
        this.remoteBetas = remoteBetas ?? [];
    ...
    async loaded() {
        ...
        const configuration = await parseConfigurationFile(parseStrictSchemaEnabled ? deepStrict(appSchema) : appSchema, configurationPath);
