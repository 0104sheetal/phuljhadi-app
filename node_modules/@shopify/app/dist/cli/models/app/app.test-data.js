...
export function testApp(app = {}, schemaType = 'legacy') {
    ...
    ], app.allExtensions ?? [], app.usesWorkspaces ?? false, app.dotenv, app.errors, app.specifications, app.configSchema);
...
export async function buildVersionedAppSchema() {
    const configSpecifications = (await loadFSExtensionsSpecifications()).filter((spec) => spec.appModuleFeatures().includes('app_config'));
    return {
