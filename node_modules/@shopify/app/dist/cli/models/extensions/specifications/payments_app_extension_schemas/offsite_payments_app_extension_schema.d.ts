...
export declare const OFFSITE_TARGET = "payments.offsite.render";
export declare const OffsitePaymentsAppExtensionSchema: zod.ZodEffects<zod.ZodEffects<zod.ZodObject<{
    name: zod.ZodString;
...
export declare function offsitePaymentsAppExtensionDeployConfig(config: OffsitePaymentsAppExtensionConfigType): Promise<{
    [key: string]: unknown;
} | undefined>;
